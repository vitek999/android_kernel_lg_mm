 ...
 *	20150914: ae?eCOofae e¡§II¡Ë¡ÍaoECsetting¢®I¢®©­nia¨Ï¢®uesetting.
 *	20150914: night mode video -> capture rad sceen, because the current fps = 15,and not modify in capture.
 * Description:
 * ------------
 *	 Source code of Sensor driver
 *
 *	PengtaoFan
 @DateTime:    20150918141920 remove set_max_framerate_by_scenaio setdummy
 @DateTime:    20150922104857 the hdr ev0  bright than normal capture,not got the root cause,but raw is ok.
 -------------------------------
 @DateTime:    20150922105044 pass!
...
extern unsigned int g_SensorIDInfo[2];
...
#else //y90 Front Camera
	.i2c_addr_table = {0x50, /*0x40,*/ /*0x20,*/0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
#endif
...
//NOT USE FOR HI553 2LANE MT6582
/*
...
static kal_uint32 open(void)
{
    ...
    LOG_INF("g_SensorIDInfo[0]=%x, g_SensorIDInfo[1]=%x.\n", g_SensorIDInfo[0],g_SensorIDInfo[1]);

    /* initail sequence write in  */
    if( g_SensorIDInfo[0] == 0x553)
    {
        imgsensor.mirror = IMAGE_V_MIRROR;
    }
    else if( g_SensorIDInfo[1] == 0x553)
    {
...
/*	SET_PD_BLOCK_INFO_T *PDAFinfo;*/
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE: //for factory mode auto testing
            ...
            *feature_para_len=4;
            break;
        //[LGE_UPDATE_S][yonghwan.lym@lge.com][2015-09-24] add FOV value.
...
#if defined (TARGET_MT6582_Y50)
                *pHorFOV = (0x39)<<16 | (0x39); // 16:9 = 57, 4:3 = 57 // (57)<<16 | (57)
#else
                *pHorFOV = (0x45)<<16 | (0x45); // 16:9 = 69, 4:3 = 69 // (69)<<16 | (69)
#endif
                *pVerFOV = (0x31)<<16 | (0x31); // 16:9 = 49, 4:3 = 49 // (49)<<16 | (49)
                *feature_para_len = 8;
                break;
            }
        //[LGE_UPDATE_E][yonghwan.lym@lge.com][2015-09-24] add FOV value.
...
/*		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			hi553_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;	*/
        /******************** PDAF END   <<< *********/
        default:
            break;
