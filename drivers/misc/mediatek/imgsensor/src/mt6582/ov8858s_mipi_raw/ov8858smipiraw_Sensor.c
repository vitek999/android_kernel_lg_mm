...
#ifdef OV8858S_DEBUG
	#define OV8858SDB(fmt, arg...) pr_debug(fmt, ##arg)
#else
...
#if 0 // LGE_UPDATE [yonghwan.lym@lge.com] 2016/03/31, CTS patfh - testCameraToSurfaceTextureMetadata
...
#else
    OV8858S_line_length = OV8858S_VIDEO_PERIOD_PIXEL_NUMS;
#endif
#ifdef OV8858S_DEBUG
...
#else
    OV8858S_frame_length = OV8858S_FeatureControl_PERIOD_LineNum;
#endif
#ifdef OV8858S_DEBUG
