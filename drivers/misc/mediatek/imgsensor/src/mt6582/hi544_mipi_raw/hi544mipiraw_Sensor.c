...
void HI544_write_shutter(kal_uint32 shutter)
{
	...
	if(HI544.HI544AutoFlickerMode == KAL_TRUE)
	{
        ...
        line_length = HI544_FeatureControl_PERIOD_PixelNum;
        max_shutter = HI544_FeatureControl_PERIOD_LineNum;		
		...
		switch(HI544CurrentScenarioId)
		{
			...
			case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
				...
				{
					min_framelength = (HI544.videoPclk*10000) /(HI544_FULL_PERIOD_LINE_NUMS + HI544.DummyLines)/304*10 ;
				}
				else if(VIDEO_MODE_TARGET_FPS==15)
				{
					min_framelength = (HI544.videoPclk*10000) /(HI544_FULL_PERIOD_LINE_NUMS + HI544.DummyLines)/148*10 ;
				}
				else
				{
...
#else
        frame_length = HI544_FeatureControl_PERIOD_LineNum + extra_lines ;
#endif
